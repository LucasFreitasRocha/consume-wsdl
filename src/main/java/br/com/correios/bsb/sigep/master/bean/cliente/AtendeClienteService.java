 ...
 * 
 */
@WebServiceClient(name = "AtendeClienteService", targetNamespace = "http://cliente.bean.master.sigep.bsb.correios.com.br/", wsdlLocation = "/wsdl/cep.wsdl")
    ...
    extends Service
{
    ...
    static {
        ATENDECLIENTESERVICE_WSDL_LOCATION = br.com.correios.bsb.sigep.master.bean.cliente.AtendeClienteService.class.getResource("/wsdl/cep.wsdl");
        WebServiceException e = null;
        if (ATENDECLIENTESERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find '/wsdl/cep.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
